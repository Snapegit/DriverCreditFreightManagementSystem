	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">司机手机：</div>
					<el-input class="list_inp"
						 v-model="registerForm.sijishouji" 
						 placeholder="请输入司机手机"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.sijishouji)){
			context?.$toolUtil.message(`司机手机不能为空`,'error')
			return false
		}
		if(registerForm.value.sijishouji&&(!context?.$toolUtil.isMobile(registerForm.value.sijishouji))){
		...
		if((!registerForm.value.chepaihao)){
			context?.$toolUtil.message(`车牌号不能为空`,'error')
			return false
		}
		if(registerForm.value.xinyongfen&&(!context?.$toolUtil.isIntNumer(registerForm.value.xinyongfen))){
