	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('siji','审核')" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('siji','修改')">修改</el-button>
						<el-button type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('siji','删除')">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
