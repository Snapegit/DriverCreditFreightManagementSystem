	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">货主账号：</div>
					<input class="list_inp"
					 v-model="registerForm.huozhuzhanghao" 
					 placeholder="请输入货主账号"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">货主姓名：</div>
					<input class="list_inp"
					 v-model="registerForm.huozhuxingming" 
					 placeholder="请输入货主姓名"
					 type="text"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">货主手机：</div>
					<input class="list_inp"
					 v-model="registerForm.huozhushouji" 
					 placeholder="请输入货主手机"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.huozhuzhanghao)){
		...
		if((!registerForm.value.huozhuxingming)){
			context?.$toolUtil.message(`货主姓名不能为空`,'error')
			return false
		}
		if((!registerForm.value.huozhushouji)){
			context?.$toolUtil.message(`货主手机不能为空`,'error')
			return false
		}
		if(registerForm.value.huozhushouji&&(!context?.$toolUtil.isMobile(registerForm.value.huozhushouji))){
