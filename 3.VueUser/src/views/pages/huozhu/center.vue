		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="8">
							<el-form-item prop="huozhuzhanghao" label="货主账号">
								<el-input class="list_inp" v-model="userForm.huozhuzhanghao" placeholder="货主账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
						...
						<el-col :span="8">
							<el-form-item prop="huozhuxingming" label="货主姓名">
								<el-input class="list_inp" v-model="userForm.huozhuxingming" placeholder="货主姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="huozhushouji" label="货主手机">
								<el-input class="list_inp" v-model="userForm.huozhushouji" placeholder="货主手机" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.huozhuzhanghao)
