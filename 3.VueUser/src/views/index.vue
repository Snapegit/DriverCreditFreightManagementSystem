<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">基于司机信用评价的货运管理系统</div>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'siji'){
				context?.$toolUtil.storageSet("frontName", res.data.data.sijizhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'siji'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'huozhu'){
